...
<html lang="en">
    ...
    <body>
                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="pendingoders.php" class="nav-item nav-link active">Pending Oders</a>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Pending Oders</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                <li class="breadcrumb-item"><a href="#">Pages</a></li>
                <li class="breadcrumb-item active text-white">Pending Oders</li>
            </ol>
        </div>
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                <div class="table-responsive">
                    <?php
                        $selectQuery = "SELECT * FROM pendingoders WHERE username = '$userName'";
                        $pendingResult = mysqli_query($con,$selectQuery);
                 ...
                 <?php        while($rows = mysqli_fetch_assoc($pendingResult)){?>
                    <tbody>
