                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="deleteCategory.php">Delete Category</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
<?php
    ...
    if(isset($_GET["catName"])){
        ...
        $deleteQuery = "DELETE FROM category WHERE catname = '$catName'";
                                    ...
                                    <div class="page-body breadcrumb-page">
                                        ...
                                        <div class="card">
                                            <div class="card-block">
                                                ...
                                                <div class="row">
                                                        <div class="col">
                                                            <input  class="form-control" name="catName" placeholder="CategoryName" type="text" required>
                                                        </div>
                                                        <div class="col">
                                                           <button type="submit" name="catDeleteBtn" class="btn btn-danger">Delete Category</button>
                                                        </div>
                                                        <?=$message ?>
                                                    </div>
                                                </form>
                                                ...
                                                <form   method="Get">
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                           <button type="submit" name="catSearchBtn" class="btn btn-success">Search Category</button>
                                                        </div>
                                                    </div>
                                                </form><br>
                                <?php
                                $mes ="";
                                    if(isset($_GET["catSearchBtn"])){
                                        $catType = $_GET["catType"];
                                        $selectQuery = "SELECT * FROM category WHERE cattype = '$catType'";
                                        $searchResult = mysqli_query($con,$selectQuery); 
                                        if(mysqli_num_rows($searchResult) > 0){
                                            echo '<table class="table table-striped table-hover"><th>category name</th><th>Discription</th><th>Category type</th><th>Quantity</th><th>Price</th>';  
                                            while($row = mysqli_fetch_assoc($searchResult)){
                                            echo "<tr>";
                                            echo "<td> ". $row['catname'] ."</td>";
                                            echo "<td> ". $row['catdiscription'] ."</td>";
                                            ...
                                            echo "</table>";
                                                ...
                                                $mes = '<div class="alert alert-primary d-flex align-items-center" role="alert">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-exclamation-triangle-fill flex-shrink-0 me-2" viewBox="0 0 16 16" role="img" aria-label="Warning:">
                                                    <path d="M8.982 1.566a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767L8.982 1.566zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
                                                </svg>
                                                <div>
