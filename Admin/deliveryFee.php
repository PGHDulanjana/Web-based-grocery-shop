            ...
            <div class="pcoded-main-container">
                <div class="pcoded-wrapper">
                    ...
                    <div class="pcoded-content">
                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                                ...
                                <?php
                                //delivery price update Query
                                $message = "";
                                    include("conn.php");
                                        if(isset($_GET["changeBtn"])){
                                            $dPrice = $_GET["dPrice"];
                                            $district = $_GET["district"];
                                            $updateQuery = "UPDATE deliveryfee SET deliveryprice = '$dPrice' WHERE district = '$district'";
                 ...
                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-exclamation-triangle-fill flex-shrink-0 me-2" viewBox="0 0 16 16" role="img" aria-label="Warning:">
                  ...
                  <div>
                    Successfully Delivery price updated !
                  </div>
                 </div>';
                                            }else{
                                                $message = '<div class="alert alert-primary d-flex align-items-center" role="alert">
                  ...
                  there is some error !
                                    ...
                                    <div class="page-body breadcrumb-page">
                                        ...
                                        <div class="card">
                                            ...
                                            <h5>Change Delivery Price</h5><br>
                                            <form method = "Get">
                                                <div class = "row">
                                                <div class="col">
                                                        ...
                                                        <div class = "col">
                                                            <input class="form-control" type="number" placeholder="Delivery Price" name="dPrice" required>
                                                        </div>
                                                    <div class = "col">
                                                        <input type="submit" name = "changeBtn" class="btn btn-success" value="Change">
                                                    </div>
                                                </div><br>
                                                <?=$message ?>
                                            </form><br>
                                                <h5>Dilivery fee Chart</h5><br>
                                                    <?php
                                                        $selectQuery = "SELECT * FROM deliveryfee";
                                                        $result = mysqli_query($con,$selectQuery);
                                                        if(mysqli_num_rows($result) > 0){
                                                           echo '<table class="table table-striped table-hover"> <th>District</th><th>Price</th>';
                                                            while($row = mysqli_fetch_assoc($result)){
                                                               echo "<tr>";
                                                               echo "<td>".$row['district']."</td>";
                                                               echo "<td>".$row['deliveryprice']."</td>";
                                                               echo "</tr>";
                                                            }
                                                            echo'</table>';
                                                        }
