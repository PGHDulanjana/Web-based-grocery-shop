                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body breadcrumb-page">
                                        ...
                                        <div class="card">
                                            ...
                                            <h5>Complite oders</h5><br>
                                            
                                             
                                            <?php
                                                $selectcomplite = "SELECT * FROM completeoders";
                                                $compliteResult = mysqli_query($con,$selectcomplite);
                                                if(mysqli_num_rows($compliteResult) > 0){
                                                   echo '<table class="table table-hover"><th>UserNmae</th><th>Category Name</th><th>Category Price</th><th>quantity</th><th>Category type</th>';
                                                    while($complitegRows = mysqli_fetch_assoc($compliteResult)){
                                                       echo "<tr>";
                                                       echo "<th>".$complitegRows['username'] ."</th>";
                                                       echo "<th>".$complitegRows['catname'] ."</th>";
                                                       echo "<th>".$complitegRows['catprice'] ."</th>";
                                                       echo "<th>".$complitegRows['quantity'] ."</th>";
                                                       echo "<th>".$complitegRows['cattype'] ."</th>";
                                                       echo "</tr>";
                                                    }
                                                    echo "</table>";
                                                }
