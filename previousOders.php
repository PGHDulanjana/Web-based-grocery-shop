                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="previousoders.php" class="nav-item nav-link active">previous Oders</a>
                        </div>
        ...
        <div class="container-fluid py-5">
            <div class="container py-5">
                <div class="table-responsive">
                    <?php
                        $selectQuery = "SELECT * FROM completeoders WHERE username = '$userName'";
                        $compledeResult = mysqli_query($con,$selectQuery);
                        if(mysqli_num_rows($compledeResult) > 0){?>
                            <table class="table"> 
                        <thead>
                          <tr>
                 ...
                 <?php        while($rows = mysqli_fetch_assoc($compledeResult)){?>
                    <tbody>
